//! Orchestration: DWT forward/reverse and coefficient scaling.
//!
//! Lifting kernels live in `lifting97i` / `lifting97f`; band regroup in `coeff_group`.

use crate::error::{BpeError, BpeResult};
use crate::types::{
    alloc_image_f32, CodingPara, HeaderPart4, ImageF32, ImageI32, FLOAT_WAVELET, INTEGER_WAVELET,
};
use crate::wavelet::coeff_group::{coeff_regroup, coeff_regroup_f97};
use crate::wavelet::lifting97f::lifting_f97_2d;
use crate::wavelet::lifting97i::lifting_m97_2d;
